...
data_dir = "/soe/chvillal/EEG_Alcoholism_Classification/Data/cnn-data-ready"
...
# create output file
filename = "cnn_" + datetime.datetime.now().replace(microsecond=0).isoformat() + ".txt"
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=True):
    ...
    #model.load_state_dict(torch.load("/soe/chvillal/EEG_Alcoholism_Classification/inception.pt"))
...
torch.save(model_ft.state_dict(), "/soe/chvillal/EEG_Alcoholism_Classification/inception.pt")
